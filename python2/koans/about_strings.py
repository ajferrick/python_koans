...
class AboutStrings(Koan):
    ...
    def test_use_backslash_at_the_end_of_a_line_to_continue_onto_the_next_line(self):
        # We learn that newline characters count towards string length.
...
"""
    ...
    def test_adjacent_strings_are_concatenated_automatically(self):
        # This is cool but marks it slightly hard to read...
        # Also, turns out you can't do this with variables. Worth a try!
        string = "Hello" ", " "world"
        self.assertEqual("Hello, world", string)
